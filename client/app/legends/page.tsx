                ...
                <div className="grid grid-cols-3 gap-8 p-4">
                    <div className="relative h-full w-full rounded-xl overflow-hidden animate-fade-left bg-transparent group">
                        <img
                            ...
                            alt="Joueur"
                            className="absolute h-72 top-10 left-1/2 -translate-x-1/2 w-52 h-auto object-cover z-10 rounded-xl"
                        />
                    ...
                    <div className="relative w-full h-96 rounded-xl overflow-hidden animate-fade-left animate-delay-[400ms] bg-transparent group">
                        ...
                        <img
                            ...
                            alt="Joueur"
                            className="absolute h-72 top-10 left-1/2 -translate-x-1/2 h-auto object-cover z-10 rounded-xl"
                        />
                    ...
                    <div
                        ...
                        <img
                            ...
                            alt="Joueur"
                            className="absolute top-10 h-72 left-1/2 -translate-x-1/2 h-auto object-cover z-10 rounded-xl"
                        />
