      ...
      <div className="w-full max-w-screen-xl p-4">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-white sm:mb-0">
            <li>
              <a href="https://www.instagram.com/accounts/login/?next=https%3A%2F%2Fwww.instagram.com%2Fasm_rugby_officiel%2F%3Fhl%3Dfr&is_from_rle" className="hover:text-yellow-400 px-4 me-4 md:me-6">
                <svg
            ...
            <li>
              <a href="https://x.com/ASMOfficiel?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" className="px-4 me-4 md:me-6">
            ...
            <li>
              <a href="https://www.facebook.com/@asm.clermont.auvergne/?locale=fr_FR" className="px-4 me-4 md:me-6">
                <svg
                  viewBox="0 0 1024 1024"
                  fill="currentColor"
            ...
            <li>
              <a href="https://www.asm-rugby.com/" className="px-4 me-4 md:me-6">
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
